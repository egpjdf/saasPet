...
class StoreWorkspaceRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $this->user()?->can('create', [Workspace::class, $organization]) ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => ['required', 'string', 'max:100', 'alpha_dash', Rule::unique('workspaces', 'slug')->where('organization_id', $organization->id)],
